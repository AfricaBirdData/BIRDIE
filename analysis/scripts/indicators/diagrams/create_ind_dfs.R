...
source("analysis/scripts/indicators/diagrams/createGraphDf.R")
...
source("analysis/scripts/indicators/diagrams/createGraph.R")
...
source("analysis/scripts/indicators/diagrams/combineGraphs.R")

graph_comb <- combineGraphs(list(sp_gr, sit_gr, sptpe_gr, sitpe_gr))

render_graph(graph_comb)

export_graph(graph_comb, file_name = "analysis/scripts/indicators/diagrams/all_graph_comb.png", file_type = "PNG")
...
# Find one route
source("analysis/scripts/indicators/diagrams/createConditionGraph.R")

render_graph(createConditionGraph(ind_df, c("at", "across", NA), c("site_type", "sp_type", NA), output = "graph"))

# Find all routes
source("analysis/scripts/indicators/diagrams/createAllConditionGraphs.R")
