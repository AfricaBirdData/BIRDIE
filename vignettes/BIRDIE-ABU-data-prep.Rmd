...
We would then only analyse data for those species that have been counted in at least
five sites with these characteristics. Those species that don't meet the requirements
should be analysed differently, although we still don't have an alternative model for
them.
...
We may use environmental covariates to model abundance, which
requires count data to be annotated with this information. To 
